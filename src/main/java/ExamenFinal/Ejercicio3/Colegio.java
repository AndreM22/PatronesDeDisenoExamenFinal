...
public class Colegio implements Control {
	IRedSocial esc;
	String nombre;
	int capacidad;
	...
	public Colegio(String nombre, int capacidad, IRedSocial esc, String requisitos) {
		this.esc = esc;
		this.nombre = nombre;
	...
	public void mostrarDatos() {
		System.out.println("**Mostrando datos de Colegio**");
