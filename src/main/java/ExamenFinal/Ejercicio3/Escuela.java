...
public class Escuela implements Control {
	IRedSocial esc;
	String nombre;
	int capacidad;
	...
	public Escuela(String nombre, int capacidad, IRedSocial esc, String requisitos) {
		this.esc = esc;
		this.nombre = nombre;
	...
	public void mostrarDatos() {
		System.out.println("**Mostrando datos de Escuela**");
